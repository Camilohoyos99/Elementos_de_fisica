...
GRAV = 9.8
DRAG = .01 * GRAV# preguntar que esto ?? resistencia del viento

# initial position, velocity; acceleration
x0, y0 = 0., 0.
v0, alpha0 = 5., 45 # ángulo inicial 
...
# rounding up
x_max, y_max = math.ceil(x_max), math.ceil(y_max) # funcion techo

# time interval
t = np.linspace(0., t_max) # el por defecto da 100 puntos
#print(t)
...
# =============================================================================
# hasta este punto solo se han dado condiciones iniciales y escrito las 
#equaciones correspondientes 
# =============================================================================
...
""" de donde saco la documentación par enterarme de esos metodos
    por qué x[a.u]?"""
...
""" preguntar por esta última linea"""
...
def init():
    line.set_data(xdata, ydata) # crear un conjunto de lineas entre los datos
#    x & y
    time_text.set_text('')
